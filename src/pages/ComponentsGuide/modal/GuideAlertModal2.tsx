...
export default function GuideAlertModal2() {
  ...
  const [handleOpenForCustomMessage, handleCloseForCustomMessage, isCustomModalOpen, messageOfCustomModal] =
    useAlertModal({
      message: (
        <>
          <div
  ...
  return (
    <>
      <ButtonInAlert
        ...
        size="large"
        onClick={handleOpenForCustomMessage}
      />
      <AlertModal
        handleClose={handleCloseForCustomMessage}
